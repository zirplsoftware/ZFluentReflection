...
{
    internal class TypeNameSubQuery<TMemberInfo, TReturnQuery> : SubQueryBase<TMemberInfo, TReturnQuery>,
        ITypeNameSubQuery<TMemberInfo, TReturnQuery>
        where TMemberInfo : MemberInfo
        where TReturnQuery : IQueryResult<TMemberInfo>
    {
        private readonly TypeNameCriteria _nameCriteria;

        internal TypeNameSubQuery(TReturnQuery returnQuery, TypeNameCriteria nameCriteria)
            :base(returnQuery)
        {
        ...
        {
            _nameCriteria.UseFullName = true;
            return this;
        }
    }
}
