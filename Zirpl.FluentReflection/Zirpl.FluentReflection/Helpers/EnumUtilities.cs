...
namespace Zirpl.FluentReflection
{
    internal static class EnumUtilities
    {
        ...
        internal static bool ContainsFlag<T>(this T value, T flags) where T : struct
        {
            Type type = typeof(T);
        ...
        internal static T AddFlag<T>(this T value, T flags) where T : struct
        {
            Type type = typeof(T);
        ...
        internal static T RemoveFlag<T>(this T value, T flags) where T : struct
        {
            Type type = typeof(T);
